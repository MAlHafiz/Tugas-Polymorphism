public class Simulator {
    public static void main(String[] args) {
        ...
        int totalJamSibuk = 0;
        totalJamSibuk = totalJamSibuk + Fairuzikun.getJamSibuk();
        totalJamSibuk = totalJamSibuk + Angel.getJamSibuk();
        totalJamSibuk = totalJamSibuk + Raja.getJamSibuk();
        totalJamSibuk = totalJamSibuk + Firman.getJamSibuk();
        totalJamSibuk = totalJamSibuk + Nidtopas.getJamSibuk();
        totalJamSibuk = totalJamSibuk + Nivotko.getJamSibuk();
